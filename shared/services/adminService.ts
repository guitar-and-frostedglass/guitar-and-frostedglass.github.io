...
import type { AdminUser, InviteCode, DeletedReply, DeletedNote, ApiResponse } from '../types'

export interface AdminService {
  getUsers(): Promise<AdminUser[]>
  deleteUser(id: string): Promise<void>
  updateUserRole(id: string, role: string): Promise<AdminUser>
  generateInviteCode(email?: string): Promise<InviteCode & { emailSent?: boolean }>
  getInviteCodes(): Promise<InviteCode[]>
  getDeletedReplies(): Promise<DeletedReply[]>
  getDeletedNotes(): Promise<DeletedNote[]>
